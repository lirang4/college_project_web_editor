...
public final class ConditionExamination
{
    ...
    private static boolean ResolveCondition(PrameterParser par1 , PrameterParser par2 ,String operator, List<ParamterItem> params)
    {
        ...
        else if(par1.getVarType() == par2.getVarType() && par1.getVarType() == analyzer.graphes.Enums.Variables.Double)
        {
...
{
    private analyzer.graphes.Enums.Variables varType;
    ...
    private analyzer.graphes.Enums.Variables ExtractType(String parameter)
    {
    ...
    public analyzer.graphes.Enums.Variables getVarType() {
        return varType;
    }
    ...
    public void setVarType(analyzer.graphes.Enums.Variables varType) {
